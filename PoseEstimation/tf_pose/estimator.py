...
from PoseEstimation.tf_pose.common import CocoPart
from PoseEstimation.tf_pose.tensblur.smoother import Smoother

try:
    from PoseEstimation.tf_pose.pafprocess import pafprocess
...
class TfPoseEstimator:
    ...
    def draw_humans(npimg, humans, imgcopy=False):
        ...
        for human in humans:
            # draw point
            for i in range(e.CocoPart.Background.value):
